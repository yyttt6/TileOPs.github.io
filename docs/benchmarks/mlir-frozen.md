# tilelang-mlir-ascend frozen measurements

<div class="mlir-scope-note"><p><strong>tilelang-mlir-ascend: cross-process frozen, pool-out absolute time.</strong> Measured 2026-09-14 UTC. T302 minimum device_us from three independent samples; minimum across variants of the same workload. Measured in separate profiler sessions from ours. Do not derive an MLIR/ours ratio; excluded from D036 candidates, headline ratios and grading. An empty cell means no publishable frozen measurement for that workload.</p></div>


Visible operators: 22/23; workloads: 51/53 (frozen-table denominators).

Current coverage captured: 2026-09-15T11:56:12.122641+00:00
...
## Frozen workloads not displayed
